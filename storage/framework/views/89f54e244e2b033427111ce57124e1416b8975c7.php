                    ...
                    <div class="mobile_wrapper">
                        ...
                        <div id="menu" class="text-left ">
                            <ul class="header_main_menu">
                                ...
                                <li class="header_submenu_item">
                                    <a href="<?php echo e(route('custom-made')); ?>"> Custom Made Computers</a>
                                </li>
                            ...
                            <div class="main_menu header_menu_position">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="<?php echo e(route('custom-made')); ?>"> Custom Made Computers</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <!--main menu end-->
...
<?php /**PATH D:\wamp64\www\marvel\resources\views/themes/ekart/common/header.blade.php ENDPATH**/ ?>