...
class CheckoutController extends CartController
{
    ...
    public function address(Request $request)
    {
        ...
        if (intval($request->id ?? 0)) {
            ...
            if (isset($addressExist->id)) {
                ...
                $request->session()->put('checkout-address-id', $addressExist->id);
    ...
    public function proceed(Request $request)
    {
        ...
        if (isset($cart['cart']) && is_array($cart['cart']) && count($cart['cart'])) {
            ...
            $data[api_param('address_id')] = session()->get('checkout-address-id');
            ...
            switch ($request->paymentMethod) {
                ...
                case 'paypal':
                    ...
                    break;
                case 'stripe':
                    $request->session()->put('tmp_payment', $data);
        ...
        return (!$return) ? redirect()->route('checkout-payment')->with('err', $msg) : $return;
    }
}
