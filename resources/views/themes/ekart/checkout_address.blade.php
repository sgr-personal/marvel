                ...
                <div class="row">
                    <div class="col-md-12" id="address">
                        <div class="card shadow mb-4">
                            <p class="product-name pb-0 font-weight-bold head title-sec"
                               id="mydesc">{{__('msg.delivery_address')}}</p>
                            <hr class="mb-0">
                            <table class="table table-borderless table-shopping-cart" aria-describedby="mydesc"
                                   aria-hidden="true">
                                <tr>
                                    <td>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{ route('checkout-address') }}" method="POST">
                                                    @foreach($data['address'] as $a)
                                                        @if(isset($a->id) && intval($a->id))
                                                            ...
                                                            <span class="form-group edit-delete">
                                                                <button class="btn editAddress"
                                                                        data-data='{{ json_encode($a) }}'> <em
                                                                        class="fa fa-pencil-alt"></em></button>
                                                                <a href="{{ route('address-remove', $a->id) }}"
                                                                   class="btn"> <em
                                                                        class="fas fa-times text-danger"></em></a>
                                                            </span>
                                                                ...
                                                                <label>
                                                                    ...
                                                                    <label
                                                                        class="badge badge-primary">{{ $a->type }}</label>
                                                                    @if(isset($a->is_default) && intval($a->is_default))
                                                                        <label
                                                                            class="badge badge-primary">{{__('msg.default')}}</label>
                                                                    @endif
                                                    ...
                                                    <div class="form-group mb-0 float-right">
                                                        <span onclick="address()"
                                                              class="btn btn-primary text-uppercase">{{__('msg.add_new_address')}}</span>
                                                        @if(isset($data['address'][0]))
                                                            <button type="submit"
                                                                    class="btn btn-primary text-uppercase add-to-cart">{{__('msg.confirm')}}
                                        ...
                                        <form action='{{ route('address-add') }}' id='formEditAddress' method="POST">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col">
                                                    ...
                                                    <input class="form-control" id='editPhone' type="number"
                                                           name="mobile">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <label class="radio-inline">
                                                    <input class="mr-2" type="radio" name="type" checked
                                                           value="Home">{{__('msg.home')}}
                                                </label>
                                                <label class="radio-inline  ml-5">
                                                    <input class="mr-2" type="radio" name="type"
                                                           value="Work">{{__('msg.work')}}
                                                </label>
                                                <label class="radio-inline  ml-5">
                                                    <input class="mr-2" type="radio" name="type"
                                                           value="Other">{{__('msg.other')}}
                                                </label>
                                            </div>
                                            <div class="form-row mb-4 mt-3">
                                                <input type="checkbox" name="is_default" class=" mt-1"/>
                                                <label class="control-label"
                                                       for="default-address"> {{__('msg.set_as_default_address')}}</label>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit"
                                                        class="btn btn-primary btn-block text-uppercase"> {{__('msg.update')}} </button>
                                                <button
                                                    class="btn btn-primary btn-block text-uppercase AddEditAddressCancel"> {{__('msg.cancel')}} </button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg">
                                    <form action='{{ route('address-add') }}' id='formAddAddress' method='POST'>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col">
                                                <label>{{__('msg.mobile_no')}}</label>
                                                <input class="form-control" id='addPhone' type="number"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col">
                                                ...
                                                <input class="form-control" type="number"
                                                       placeholder="Altername Mobile No" name="alternate_mobile">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col">
                                                <label>{{__('msg.country')}}</label>
                                                <input class="form-control" type="text" name="country" value="Kenya"
                                                       readonly placeholder="Country">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <label class="radio-inline">
                                                <input class="mr-2" type="radio" name="type" value="Home"
                                                       checked>{{__('msg.home')}}
                                            </label>
                                            <label class="radio-inline  ml-5">
                                                <input class="mr-2" type="radio" name="type"
                                        ...
                                        <div class="form-group">
                                            <button type="submit"
                                                    class="btn btn-primary btn-block text-uppercase"> {{__('msg.add_new_address')}} </button>
                                            <button
                                                class="btn btn-primary btn-block text-uppercase AddEditAddressCancel"> {{__('msg.cancel')}} </button>
                                        </div>
                                    </form>
