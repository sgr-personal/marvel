            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="icondiv justify-content-center d-flex tossing">
                        <img src="{{ asset('images/icon1.png') }}" alt="phone">
                    </div>
                    
                    <h6 class="text-center my-3 font-weight-bold title-contact">Call Us</h6>
                  
                    <p class="text-center text-capitalize"><strong class="font-weight-bold">Phone:</strong> {{ Cache::get('whatsapp_number') }}<br>
                       
                </div>
                <div class="col-md-4">
                    <div class="icondiv justify-content-center d-flex floating">
                        <img src="{{ asset('images/icon2.png') }}" alt="location">
                    </div>
                ...
                <div class="col-md-4">
                    <div class="icondiv justify-content-center d-flex pulse">
                        <img src="{{ asset('images/icon3.png') }}" alt="visit">
                    </div>
                 
                    <h6 class="text-center my-3 font-weight-bold title-contact">Write Us</h6>
                    
                    <p class="text-center text-capitalize"> <strong class="font-weight-bold">Email:</strong>{{ Cache::get('support_email') }}</p>
