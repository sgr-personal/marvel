                ...
                <div class="card">
                    ...
                    <form action='#' method="GET" id='filter'>
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div id="slider-range" data-min="{{ intval($data['min_price']) }}" data-max="{{ intval($data['max_price']) + 1 }}" data-selected-min="{{ intval($data['selectedMinPrice']) }}" data-selected-max="{{ intval($data['selectedMaxPrice'])+1 }}"></div>
                                    <br>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    @if(isset(Cache::get('categories',[])[$cat]) && isset(Cache::get('categories',[])[$cat]->childs))
                    <br>
                    <div>
